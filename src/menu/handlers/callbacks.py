...
async def easy_handler(callback: types.CallbackQuery, state: FSMContext):
...
async def medium_handler(callback: types.CallbackQuery, state: FSMContext):
...
async def difficult_handler(callback: types.CallbackQuery, state: FSMContext):

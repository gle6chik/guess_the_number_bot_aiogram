...
def get_statistics_cleaning_confirmation():
    builder = InlineKeyboardBuilder()
    
    builder.button(text='Отмена', callback_data='clean_confirm_no')
    builder.button(text='Да', callback_data='clean_confirm_yes')
